...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <header class="hero-contact py-5 text-center">
        <div class="container py-4">
            <span
                class="badge bg-secondary bg-opacity-25 text-secondary mb-3 px-3 py-2 rounded-pill text-uppercase small fw-semibold">Get
                In Touch</span>
            <h1 class="display-4 fw-bold text-white mb-3">Let's Connect and <br><span class="text-gradient">Talk
                    Technology</span></h1>
            <p class="lead text-secondary mx-auto" style="max-width: 600px;">
                Have questions, business inquiries, or technical feedback? Drop us a line, and our expert team will get back
                to you shortly.
            </p>
        </div>
    </header>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-12 mt-4">
                                    <button type="submit" class="btn btn-gradient fw-bold w-100 w-md-auto">Send
                                        Message</button>
                                </div>
                            </div>
                    </form>
